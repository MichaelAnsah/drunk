...
<div id="divLogin">
    <div id="divLogo">
		...
		<span style="font-size:60px">Henson Geodata Technologies HRM System<span>
    </div>
    ...
    <form id="frmLogin" method="post" action="<?php echo url_for('auth/validateCredentials'); ?>">
        ...
        <div id="divUsername" class="textInputContainer">
          ...
          <span class="form-hint" ><?php echo __(''); ?></span> 
        </div>
        ...
        <div id="divLoginButton">
            &nbsp&nbsp <input type="submit" name="Submit" class="button" id="btnLogin" value="<?php echo __('LOGIN'); ?>" />
